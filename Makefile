...
OFILES = gba.o font.o draw.o logic.o main.o images/StartScreen.o images/Grassy.o images/infinityGauntlet.o images/thanos.o images/ironman.o images/hulk.o images/thor.o images/captainamerica.o images/blackwidow.o images/spiderman.o images/drStrange.o images/blackpanther.o images/winScreen.o images/loseScreen.o
